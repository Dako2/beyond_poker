    ...
    def hand_summary(self, board: list[int], hands: list[list[int]]) -> None:
        ...
        for i in range(len(stages)):
            ...
            for player, hand in enumerate(hands):
                ...
                log += "Player {} hand = {}, percentage rank among all hands = {}\n".format(player + 1, class_string, percentage)
            ...
            if i != stages.index("RIVER"):
                if len(winners) == 1:
                    ...
                    log += "Player {} hand is currently winning.\n".format(winners[0] + 1)
                else:
                    print("Players {} are tied for the lead.\n".format([x + 1 for x in winners]))
                    log += "Players {} are tied for the lead.\n".format([x + 1 for x in winners])
